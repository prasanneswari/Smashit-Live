...
/*
    ...
    public static final String registerprofileapi = "" + url + "://" + domain_name + ":" + port + "/api/v2/users/signup";
    ...
    public static final String updateprofile_url = "" + url + "://" + domain_name + ":" + port + "/api/v2/users/updateProfile";
    ...
    public static final String searchdata_url = "" + url + "://" + domain_name + ":" + port + "/api/v2/home/searchTerms?term=";
