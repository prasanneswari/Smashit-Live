...
import static com.vasmash.va_smash.ProfileScreen.Userfollow_following.followersbtn;
...
public class Adapter_follow extends RecyclerView.Adapter<Adapter_follow.ViewHolder> implements Filterable {

    ArrayList<Model_userfollow_unfollow> mainmodels,tempCustomer, suggestions;

    String followcount, profiletype,userpic="null";
    Context context;
    private RequestQueue mQueue;

    public Adapter_follow(ArrayList<Model_userfollow_unfollow> mainmodels, Context context) {
