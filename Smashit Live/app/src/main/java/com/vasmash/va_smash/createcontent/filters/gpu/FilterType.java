...
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlBilateralFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlBoxBlurFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlBrightnessFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlBulgeDistortionFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlCGAColorspaceFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlContrastFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlCrosshatchFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlExposureFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlFilterGroup;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlGammaFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlGaussianBlurFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlGrayScaleFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlHalftoneFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlHazeFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlHighlightShadowFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlHueFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlInvertFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlLookUpTableFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlLuminanceFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlLuminanceThresholdFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlMonochromeFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlOpacityFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlPixelationFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlPosterizeFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlRGBFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlSaturationFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlSepiaFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlSharpenFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlSolarizeFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlSphereRefractionFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlSwirlFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlToneCurveFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlToneFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlVibranceFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlVignetteFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlWatermarkFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlWeakPixelInclusionFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlWhiteBalanceFilter;
import com.vasmash.va_smash.createcontent.filters.gpu.egl.filter.GlZoomBlurFilter;
    ...
    public static GlFilter createGlFilter(FilterType filterType, Context context) {
        switch (filterType) {
            ...
            case LOOK_UP_TABLE_SAMPLE:
                Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_logo_with_user);
            ...
            case WATERMARK:
                return new GlWatermarkFilter(BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_logo_with_user), GlWatermarkFilter.Position.RIGHT_BOTTOM);
            case WEAK_PIXEL:
            ...
            case BITMAP_OVERLAY_SAMPLE:
                return new GlBitmapOverlaySample(BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_logo_with_user));
            default:
                return new GlFilter();
        }
    }
